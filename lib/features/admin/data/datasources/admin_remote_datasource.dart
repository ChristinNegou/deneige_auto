...
abstract class AdminRemoteDataSource {
  ...
  Future<Map<String, dynamic>> getUsers({int page, int limit, String? role, String? search});
  ...
  Future<Map<String, dynamic>> getReservations({int page, int limit, String? status});
  Future<Map<String, dynamic>> getReservationDetails(String reservationId);
  Future<Map<String, dynamic>> refundReservation(String reservationId, {double? amount, String? reason});
  Future<void> broadcastNotification({required String title, required String message, String? targetRole});
}
...
class AdminRemoteDataSourceImpl implements AdminRemoteDataSource {
  ...
  Future<Map<String, dynamic>> getReservations({
    ...
    final response = await dio.get('/admin/reservations', queryParameters: queryParams);
    return response.data;
  }

  @override
  Future<Map<String, dynamic>> getReservationDetails(String reservationId) async {
    final response = await dio.get('/admin/reservations/$reservationId');
    return response.data;
  }

  @override
  Future<Map<String, dynamic>> refundReservation(String reservationId, {double? amount, String? reason}) async {
    final response = await dio.post('/admin/reservations/$reservationId/refund', data: {
