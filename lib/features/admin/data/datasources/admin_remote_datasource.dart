...
class AdminRemoteDataSourceImpl implements AdminRemoteDataSource {
  ...
  Future<Map<String, dynamic>> getUserDetails(String userId) async {
    try {
      ...
      throw ServerException(
          message: 'Erreur lors du chargement des détails utilisateur: $e');
    }
  }
  ...
  Future<void> suspendUser(String userId,
    ...
    try {
      ...
      throw ServerException(message: 'Erreur lors de la suspension: $e');
    }
  }
  ...
  Future<void> unsuspendUser(String userId) async {
    try {
      ...
      throw ServerException(message: 'Erreur lors de la réactivation: $e');
    }
  }
  ...
  Future<Map<String, dynamic>> getReservationDetails(
    ...
    try {
      ...
      throw ServerException(
          message: 'Erreur lors du chargement des détails de réservation: $e');
    }
  }
  ...
  Future<Map<String, dynamic>> refundReservation(String reservationId,
    ...
    try {
      ...
      throw ServerException(message: 'Erreur lors du remboursement: $e');
    }
  }
  ...
  Future<void> updateSupportRequest(String requestId,
    ...
    try {
      ...
      throw ServerException(
          message: 'Erreur lors de la mise à jour du support: $e');
    }
  }
  ...
  Future<void> respondToSupportRequest(
    ...
    try {
      ...
      throw ServerException(
          message: 'Erreur lors de la réponse au support: $e');
    }
  }
  ...
  Future<StripeReconciliation> getStripeReconciliation({
    ...
    try {
      ...
      throw ServerException(
          message: 'Erreur lors de la réconciliation Stripe: $e');
    }
  }
  ...
  Future<StripeSyncResult> syncWithStripe({
    ...
    try {
      ...
      throw ServerException(
          message: 'Erreur lors de la synchronisation Stripe: $e');
    }
  }
  ...
  Future<Map<String, dynamic>> getVerifications({
    ...
    try {
      ...
      throw ServerException(
          message: 'Erreur lors du chargement des vérifications: $e');
    }
  }
  ...
  Future<Map<String, dynamic>> getVerificationStats() async {
    try {
      ...
      throw ServerException(
          message: 'Erreur lors du chargement des stats de vérification: $e');
    }
  }
  ...
  Future<Map<String, dynamic>> getVerificationDetails(String userId) async {
    try {
      ...
      throw ServerException(
          message: 'Erreur lors du chargement des détails de vérification: $e');
    }
  }
  ...
  Future<void> submitVerificationDecision(
    ...
    try {
      ...
      throw ServerException(
          message: 'Erreur lors de la soumission de la décision: $e');
    }
  }
  ...
  Future<Map<String, dynamic>> reanalyzeVerification(String userId) async {
    try {
      ...
      throw ServerException(message: 'Erreur lors de la réanalyse: $e');
    }
  }
