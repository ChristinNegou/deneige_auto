...
class Step5SummaryScreen extends StatelessWidget {
  const Step5SummaryScreen({Key? key}) : super(key: key);
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // Location summary (read-only display)
  ...
  Widget _buildLocationSummary(BuildContext context, NewReservationState state) {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        color: Colors.white,
